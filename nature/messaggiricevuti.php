...
<br>
<h1 class="card row justify-content-center align-items-center">Messaggi Ricevuti</h1>
</head>
<body>
<br>
...
<?php
  ...
  $sql="SELECT * FROM Messaggio WHERE NicknameDestinatario='$nickname'";
  $res=$pdo->query($sql);
  while($row=$res->fetch()){
    echo ("ID: ".$row["ID"]."<br>");
    echo ("Nickname Mittente: ".$row["NicknameMittente"]."<br>");
