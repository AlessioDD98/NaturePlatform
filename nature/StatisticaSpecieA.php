...
<html lang="en">
<title>
Statistica specie animali
</title>
<head>
<meta charset="utf-8">
<link href="stilef.css" rel="stylesheet" type="text/css">
<br>
<h1 class="card row justify-content-center align-items-center">Statistica Specie Animali</h1>
</head>
<body>
<br>
...
<?php
  try {
   ...
   try{
   $sql="SELECT NomeLatino,count(*) as tot from ClassificazioneAnimale group by NomeLatino order by count(*)";
   $res=$pdo->query($sql);
     while($row=$res->fetch()){
