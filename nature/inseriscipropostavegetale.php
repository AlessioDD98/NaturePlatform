...
<html lang="en">
<title>
Inserisci Proposta Vegetale
</title>
<meta charset="utf-8">
<link href="stilef.css" rel="stylesheet" type="text/css">
<br>
<h1 class="card row justify-content-center align-items-center">Inserisci Proposta Vegetale</h1>
</head>
<body>
<br>
...
<?php
  ...
  if($idsegnalazione>0 && $classificazione!=""){
    try{
        $sql1="CALL InserimentoPropostaVegetale('$idsegnalazione','$nickname','$data','$commento','$classificazione')";
  ...
  try {
     ...
     $doc = ['_id' => new MongoDB\BSON\ObjectID(),'data'=>date("Y-m-d h:i:sa"),'name' => $nickname, 'azione' => 'Inserimento Proposta Vegetale', 'esito'=> $esito];
     $bulk->insert($doc);
